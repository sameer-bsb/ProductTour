#
#  Be sure to run `pod spec lint ProductTour.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of ProductTour in Markdown format.
  ...
  # s.authors          = { "Ahmed S." => "sameer@bsb.in" }
